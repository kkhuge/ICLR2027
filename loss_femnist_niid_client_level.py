"""Plot natural-NIID FEMNIST training, seen-client, and unseen-client losses."""
...
for name, label, color in CURVES:
    rounds, loss = load_curve(name)
    plt.plot(rounds, loss, label=label, color=color, linestyle="-", linewidth=2.0)
...
plt.yticks(np.arange(0.5, 2.01, 0.5))
